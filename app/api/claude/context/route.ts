...
export async function GET() {
  ...
  // Build per-character card counts (using slug, not id, since cards store character_id as uuid)
  // Cards store character_id as uuid — need to match against characters by id separately
  // For simplicity, count by character_id uuid, map to slug later
  ...
  // Build character stats — fetch ids too for card count matching
